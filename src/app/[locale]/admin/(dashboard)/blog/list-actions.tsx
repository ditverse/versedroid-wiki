...
export function BlogListActions({ id, published, featured }: Props) {
    ...
    return (
        <div className="flex items-center justify-end gap-1">
            <Button variant="ghost" size="icon" onClick={handleToggleFeatured} className="h-8 w-8 text-vd-text-secondary hover:text-vd-warning" title={featured ? "Unfeature" : "Feature"}>
